  ...
  return (
    <>
      <style>{`
        ...
        /* Tablet: cards side-by-side but smaller padding */
        ...
        @media (max-width: 620px) {
          ...
          /* Show Pro (dark) card first on mobile */
          .card-right { order: -1; }
          .card-left  { order: 1; }
          ...
          /* Guarantee strip: stack on small screens */
          .guarantee-strip {
            flex-direction: column;
            text-align: center;
            gap: 8px;
        ...
        <section id="planes" style={{ padding: "88px 0 100px" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 32px" }}>
            ...
            <div style={{ textAlign: "center", marginBottom: 60 }}>
              ...
              <h2 className="afu2" style={{ fontSize: "clamp(26px,4vw,46px)", fontWeight: 900, color: "#005187", lineHeight: 1.15, margin: "0 0 16px" }}>
